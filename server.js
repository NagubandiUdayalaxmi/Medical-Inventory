...
const dbName='medical_inventory';
var db
...
app.post('/AddData',(req,res)=>{
    db.collection('medicine').insertOne(({Product_Id:req.body.Product_Id,Product_Name:req.body.Product_Name,
...
app.post('/update',(req,res)=>{
    db.collection('medicine').find().toArray((err,result)=>{
        ...
        db.collection('medicine').findOneAndUpdate({Product_Id:req.body.Product_Id},{
...
app.post('/delete',(req,res)=>{
    db.collection('medicine').findOneAndDelete({Product_Id:req.body.Product_Id},(err,result)=>{
        if(err) return console.log(err)
        res.redirect('/')
    })
})
